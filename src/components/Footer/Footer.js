  ...
  <div className="row justify-content-center align-items-center py-3" style={{ backgroundColor: '#F5F7FA' }}>
    ...
    <div className="text-dark text-center py-3 pb-0">
      © Dhanesh & Co
    </div>
    <div className="text-dark text-center py-0 pt-0 pb-1 fs-6">
    Created by 
  <a href="https://www.linkedin.com/in/jeetsoni17/" className="text-dark fs-6" target="_blank">
  Jeet
  </a>
    </div>
