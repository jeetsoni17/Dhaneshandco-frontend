  ...
  return (
    <div className="h-100 border-rounded shadow-sm d-flex flex-wrap px-3 pb-3">
      <div className="w-100">
        ...
        {/* <Button to={blogData.link} text="Download pdf"/>
        <Button to={blogData.link} >Download PDF</Button> */}
        <Button to="path/to/your/file.pdf" target="_blank" rel="noopener noreferrer">
            Download PDF
        </Button>
      </div>
